...
function showRandomMemoryCard() {
  ...
  modal.innerHTML = `
    ...
    <div style="font-family:var(--mono,monospace);font-size:10px;color:var(--muted,#7a6754);letter-spacing:3px;text-transform:uppercase;animation:cineUp 1s ease-out .8s forwards;opacity:0">Click / Touch to dismiss</div>
  `;
